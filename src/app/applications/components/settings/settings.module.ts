...
@NgModule({
    declarations: [SettingsComponent, AirdropControlComponent, BluetoothControlComponent, FocusControlComponent, KeyboardBrightnessControlComponent, MusicControlComponent, ScreenMirroringControlComponent, WifiControlComponent],
    imports: [
        CommonModule
    ],
    exports: [SettingsComponent, AirdropControlComponent, BluetoothControlComponent, FocusControlComponent, KeyboardBrightnessControlComponent, MusicControlComponent, ScreenMirroringControlComponent, WifiControlComponent]
})
